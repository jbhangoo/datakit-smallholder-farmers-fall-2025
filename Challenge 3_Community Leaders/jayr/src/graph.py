...
class MultiDiGraph(object):
    ...
    def __init__(self):
        ...
        self.adj_list: Dict[str, Dict[str, List[DiGraphEdge]]] = defaultdict(lambda: defaultdict(list))
        self.nodes = set()
        self.edge_count = 0

    def add_edge(self, from_node: str, to_node: str, qid:str, **kwargs):
        """
        ...
        self.adj_list[from_node][to_node].append(edge)
        self.edge_count += 1
    ...
    def remove_node(self, node:str) -> bool:
        ...
        if node in self.nodes:
            ...
            edge_set = self.adj_list.items()
            for from_node, neighbors in edge_set:
                if node in neighbors:
                    del self.adj_list[from_node][node]
